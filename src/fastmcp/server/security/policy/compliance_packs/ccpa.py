...
_SEC_105_DELETE = ComplianceRuleSpec(
    ...
    checks=(
        MetadataCheck(metadata_key="verified_request_id"),
    ),
    deny_message=(
...
_SEC_106_CORRECT = ComplianceRuleSpec(
    ...
    checks=(
        MetadataCheck(metadata_key="correction_request_id"),
    ),
    deny_message=(
        "CCPA § 1798.106: Correction workflow requires a "
...
_SEC_125_NON_RETALIATION = ComplianceRuleSpec(
    ...
    checks=(
        MetadataCheck(metadata_key="financial_incentive_id"),
    ),
    deny_message=(
...
_SEC_100_D_SERVICE_PROVIDER = ComplianceRuleSpec(
    ...
    checks=(
        MetadataCheck(metadata_key="service_provider_contract_id"),
    ),
    deny_message=(
