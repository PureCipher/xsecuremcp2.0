...
_SEC_99_10_INSPECT = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="inspection_request_id"),),
    deny_message=(
        "FERPA 34 CFR 99.10(a): Inspection workflow requires an inspection_request_id."
    ),
...
_SEC_99_30_CONSENT = ComplianceRuleSpec(
    ...
    tags=frozenset({"education_record", "student_pii", "ferpa_regulated"}),
    checks=(
        MetadataCheck(
...
_SEC_99_31_9_JUDICIAL = ComplianceRuleSpec(
    ...
    checks=(
        MetadataCheck(
            ...
            allowed_values=frozenset({"yes", "notice_forbidden_by_order"}),
        ),
    ),
    deny_message=(
...
_SEC_99_35_AUDIT = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="study_agreement_id"),),
    deny_message=(
