...
_ART_5_MINIMIZATION = ComplianceRuleSpec(
    ...
    tags=frozenset({"pii", "personal_data", "gdpr_regulated"}),
    checks=(MetadataCheck(metadata_key="data_minimization_scope"),),
    deny_message=(
...
_ART_5_STORAGE_LIMIT = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="retention_period"),),
    deny_message=(
...
_ART_7_CONSENT_PROOF = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="consent_record_id"),),
    deny_message=(
