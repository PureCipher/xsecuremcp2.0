...
_ART_6 = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="ict_risk_framework_id"),),
    deny_message=(
        "DORA Art 6: Scoped-system actions require an ict_risk_framework_id."
    ),
...
_ART_9_INTEGRITY = ComplianceRuleSpec(
    ...
    deny_message=(
        "DORA Art 9(2): Writes to scoped data require an integrity_mechanism."
    ),
...
_ART_9_ENCRYPTION = ComplianceRuleSpec(
    ...
    deny_message=(
        "DORA Art 9(2): Sensitive ICT data in transit requires TLS 1.2 or higher."
    ),
    citation=_cite("Article 9(2)"),
)
...
_ART_10_DETECTION = ComplianceRuleSpec(
    ...
    tags=frozenset({"dora_scoped_system"}),
    checks=(MetadataCheck(metadata_key="detection_telemetry_id"),),
    deny_message=("DORA Art 10: Scoped-system calls require a detection_telemetry_id."),
...
_ART_11_RECOVERY = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="recovery_plan_id"),),
    deny_message=("DORA Art 11(1): Recovery operations require a recovery_plan_id."),
...
_ART_11_BACKUP = ComplianceRuleSpec(
    ...
    deny_message=("DORA Art 12: Backup restoration requires a backup_policy_id."),
...
_ART_28_THIRD_PARTY = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="contractual_arrangement_id"),),
    deny_message=(
        "DORA Art 28(1): Third-party ICT calls require a contractual_arrangement_id."
    ),
...
_ART_13_LEARNING = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="post_incident_review_id"),),
    deny_message=(
