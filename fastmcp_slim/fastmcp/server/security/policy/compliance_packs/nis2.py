...
_ART_21_A_RISK_ANALYSIS = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="risk_assessment_id"),),
    deny_message=(
        "NIS2 Art 21(2)(a): Calls on scoped systems require a risk_assessment_id."
    ),
...
_ART_21_B_INCIDENT = ComplianceRuleSpec(
    ...
    deny_message=(
        "NIS2 Art 21(2)(b): Actions during an active incident require an incident_id."
    ),
...
_ART_21_D_SUPPLY_CHAIN = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="supplier_assessment_id"),),
    deny_message=(
        "NIS2 Art 21(2)(d): Third-party software requires a supplier_assessment_id."
    ),
...
_ART_21_E_SECURE_DEV = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="build_attestation_id"),),
    deny_message=("NIS2 Art 21(2)(e): Deploys require a build_attestation_id."),
...
_ART_21_H_CRYPTO = ComplianceRuleSpec(
    ...
    deny_message=(
        "NIS2 Art 21(2)(h): Sensitive-data access requires TLS 1.2 or higher."
    ),
...
_ART_21_G_HYGIENE = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="hygiene_attestation_id"),),
    deny_message=(
