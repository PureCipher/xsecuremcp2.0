...
_A_5_15 = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="access_policy_id"),),
    deny_message=(
...
_A_8_3 = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="function_scope"),),
    deny_message=(
...
_A_8_5 = ComplianceRuleSpec(
    ...
    checks=(
        MetadataCheck(
            ...
            allowed_values=frozenset({"multi_factor", "hardware_token", "webauthn"}),
        ),
    ),
    deny_message=(
...
_A_8_8 = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="vulnerability_scan_id"),),
    deny_message=(
...
_A_8_10 = ComplianceRuleSpec(
    ...
    deny_message=("ISO 27001 A.8.10: Deletion workflows require a deletion_method."),
...
_A_8_12 = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="dlp_inspection_id"),),
    deny_message=(
...
_A_8_15 = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="log_stream_id"),),
    deny_message=(
        "ISO 27001 A.8.15: Scoped calls require a log_stream_id for the event log."
    ),
...
_A_8_20 = ComplianceRuleSpec(
    ...
    deny_message=("ISO 27001 A.8.20: Network egress requires a declared network_zone."),
...
_A_8_24 = ComplianceRuleSpec(
    ...
    deny_message=(
        "ISO 27001 A.8.24: Crypto operations require an approved crypto_algorithm."
    ),
