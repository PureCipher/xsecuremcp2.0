...
_CC6_1_AUTH = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="authenticated_principal"),),
    deny_message=(
        "SOC 2 CC6.1: Access to SOC-scoped data requires an authenticated_principal."
    ),
...
_CC6_3_LEAST_PRIV = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="entitlement_scope"),),
    deny_message=(
...
_CC6_7_INTEGRITY = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="data_movement_authorization"),),
    deny_message=(
...
_CC6_8_MALICIOUS = ComplianceRuleSpec(
    ...
    deny_message=("SOC 2 CC6.8: Deploys require signature_verified=true."),
...
_CC7_2_MONITOR = ComplianceRuleSpec(
    ...
    tags=frozenset({"soc2_scoped", "production_data"}),
    checks=(MetadataCheck(metadata_key="trace_id"),),
    deny_message=("SOC 2 CC7.2: Monitored calls require a trace_id."),
...
_CC7_3_INCIDENT = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="incident_id"),),
    deny_message=("SOC 2 CC7.3: Incident-response calls require an incident_id."),
...
_C1_1_HANDLE = ComplianceRuleSpec(
    ...
    tags=frozenset({"confidential", "restricted", "secret", "internal_only"}),
    checks=(
        MetadataCheck(
    ...
    deny_message=(
        "SOC 2 C1.1: Confidential data access requires a declared confidentiality_tier."
    ),
    citation=_cite("C1.1"),
)
...
_A1_2_BACKUP = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="backup_policy_id"),),
    deny_message=(
...
_PI1_1_INPUT = ComplianceRuleSpec(
    ...
    checks=(MetadataCheck(metadata_key="input_validation_id"),),
    deny_message=(
        "SOC 2 PI1.1: Integrity-critical processing requires an input_validation_id."
    ),
